...
ITEMS = [
  {
    ...
    "description": lambda: tr("Scales maximum acceleration during takeoff and cruise (0.5x - 1.0x). Default is 0.8x. Smoothes out aggressive throttle when lead cars pull away."),
